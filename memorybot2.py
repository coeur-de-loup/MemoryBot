...
# Option to preview memory store
    ...
    MODEL = st.selectbox(label='Model', options=['gpt-3.5-turbo','text-davinci-003','text-davinci-002','code-davinci-002'])#    K = st.number_input(' (#)Summary of prompts to consider',min_value=3,max_value=1000)
...
if API_O:
    ...
    print(API_O)
    llm = OpenAI(temperature=0, api_key=API_O, model_name=MODEL, verbose=False)
